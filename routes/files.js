...
const { uploadLimiter, validateFileContent, validateFileCount } = require('../middleware/fileUploadLimiter');
...
const handleUpload = (req, res, next) => {
    ...
    upload.single('file')(req, res, (err) => {
        ...
        const validExtensions = ['jpg', 'jpeg', 'png', 'webp', 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'txt'];
...
router.post('/upload', uploadLimiter, handleUpload, validateFileContent, uploadFile);
...
/**
 * @route   GET /api/files
 * @desc    List all files for a user
 * @access  Private
 */
